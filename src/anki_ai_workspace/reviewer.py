...
#anki-ai-workspace-shortcuts{position:fixed;left:64px;bottom:22px;z-index:1000;display:flex;max-width:calc(100vw - 84px);height:30px;gap:1px;margin:0;padding:2px;overflow-x:auto;overflow-y:hidden;border:1px solid rgba(255,255,255,.1);border-radius:17px;background:rgba(17,17,17,.94)!important;box-shadow:0 3px 10px rgba(0,0,0,.14);backdrop-filter:blur(12px);scrollbar-width:none}#anki-ai-workspace-shortcuts::-webkit-scrollbar{display:none}#anki-ai-workspace-shortcuts[hidden]{display:none!important}#anki-ai-workspace-shortcuts button{flex:0 0 auto;height:24px;margin:0;padding:0 10px;border:0!important;border-radius:12px;background:transparent!important;color:rgba(255,255,255,.82)!important;font-size:11px!important;font-weight:600!important;line-height:24px!important;white-space:nowrap;cursor:pointer;box-shadow:none!important;transition:background .15s ease,color .15s ease,opacity .15s ease}#anki-ai-workspace-shortcuts button:hover{background:rgba(255,255,255,.12)!important;color:#fff!important}#anki-ai-workspace-shortcuts button:disabled{opacity:.42;cursor:default;background:transparent!important}
