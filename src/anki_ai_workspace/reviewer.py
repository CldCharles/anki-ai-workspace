...
<style>
#anki-ai-workspace-launcher,#anki-ai-workspace-menu,#anki-ai-workspace-menu *,#anki-ai-workspace-panel,#anki-ai-workspace-panel *{box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;letter-spacing:normal!important;text-transform:none!important}
...
(()=>{
 ...
 const panel=q('#anki-ai-workspace-panel'),turns=q('#anki-ai-workspace-turns'),sessions=q('#anki-ai-workspace-sessions'),selector=q('#anki-ai-workspace-selector'),items=q('#anki-ai-workspace-selector-items'),composer=q('#anki-ai-workspace-composer'),sendButton=q('#anki-ai-workspace-send'),health=q('#anki-ai-workspace-health'),healthLabel=q('#anki-ai-workspace-connection-label'),connectionPopover=q('#anki-ai-workspace-connection-popover'),titlebar=q('#anki-ai-workspace-titlebar'),resize=q('#anki-ai-workspace-resize');
 ...
 addEventListener('resize',()=>{if(layout)apply(layout);placeMenu()});
})();
(()=>{
