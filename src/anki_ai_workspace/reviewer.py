...
#anki-ai-workspace-menu-profile,.anki-ai-workspace-group{padding:8px 10px 5px;color:#777;font-size:10px!important;font-weight:700!important;letter-spacing:.08em!important;text-transform:uppercase!important}#anki-ai-workspace-menu button,#anki-ai-workspace-selector button{display:flex;width:100%;min-height:38px;align-items:center;margin:0;padding:0 10px;border:0!important;border-radius:7px;background:transparent!important;color:inherit!important;font-size:13px!important;font-weight:500!important;text-align:left;cursor:pointer}#anki-ai-workspace-menu button:hover,#anki-ai-workspace-selector button:hover{background:#f2f2f2!important}.anki-ai-workspace-menu-divider{height:1px;margin:7px 4px;background:#e8e8e8}.anki-ai-workspace-empty{padding:8px 10px;color:#777;font-size:12px!important}.anki-ai-workspace-menu .anki-ai-workspace-configure{color:#666!important;font-size:12px!important;font-weight:600!important}.anki-ai-workspace-configure::before{content:"\2699";display:inline-block;width:22px;color:#777;font-size:13px!important}
